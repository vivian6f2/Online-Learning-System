...
<html>
	...
	<body bgcolor="#E8FBFD">
		...
		?>
				...
				<form name="EDIT" method="POST" action="edit_ppt_access.php<?php echo '?ppt_id='.$ppt_id.'&page='.$page; ?>">
					<ss class="font-style">Question</ss><br><br>
					<textarea name="question" style="width:600px;height:100px;" ><?php echo $old_question;?></textarea><br><br>
					<input type="submit" name="button" value="Set Question" class="button"/>
				</form>
				</td></tr>
				</table>
		<?php
				...
				if($page!=0) echo '<td width="10%" align="center"><a href="edit_ppt.php?ppt_name='.$ppt_name.'&page='.($page-1).'" class="button">Previous</a></td>';
				...
				if(file_exists('./PDF/'.$ppt_name.'/'.$ppt_name.'-'.($page+1).'.jpg')) echo '<td width="10%" align="center"><a href="edit_ppt.php?ppt_name='.$ppt_name.'&page='.($page+1).'" class="button">Next</a></td>';
				else echo '<td width="10%" align="center"></td>';
				echo '</tr>';

...
<html>
	...
	<body bgcolor="#E8FBFD">
		...
		<ss class = "font-style-title">Login</ss><br><br>
		</td></tr>
		</table>
		<table width="100%" height="40%">
		<tr><td align="center" valign="middle">
		<form name="LOGIN" method="POST" action="login_access.php">
			<ss class="font-style">Account&nbsp;:&nbsp;</ss><input type="text" name="account"/><br><br><br><br>
			<input type="submit" name="button" value="Login" class="button"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="regist.php" class="button">Regist</a><br>
		</form>
		</td></tr>
		</table>
	</body>
